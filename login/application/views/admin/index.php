		...
		<div class="row-one widgettable">
            ...
            <tbody> 
               	<?php foreach ($enquery as $enq) {?>
               	    <tr> 
               	    	<td><?php echo $enq['inqury_name']?></td>
               	    	<td><?php echo $enq['subject']?></td>
               	    	<!-- <td><?php echo $enq['message']?></td> -->
               	    	<td><?php echo $enq['inquery_email']?></td>
               	    	<td><?php echo $enq['inquery_date']?></td>
               	    	<td><?php if($enq['reply_status']==1){ echo "Reply";}
               	    			  else{ echo "Replyed" ;}?></td>
          ...
          <a href="<?php echo site_url()?>/Enquery/"> <button class="btn btn-info pull-right">More</button></a>
		</div>
