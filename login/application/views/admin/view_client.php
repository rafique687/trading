            ...
            <?php if(isset($_GET['sucess']))
              ...
              <tbody> 
                ...
                <tr> 
                  ...
                  <td>
                <?php 
                $pic= explode(",",$prod['logo']);
                
                 $default=base_url()."defualt/defualt.jpg";?>
                 <img src='<?php echo base_url().'client/'.$pic['0']?>' onerror="this.onerror=null; this.src='<?php echo $default; ?>'" height="50" width="50">
                  </td>
