			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form  action="<?php echo site_url()?>/Services/inser_edititem" method="post" method="post" enctype="multipart/form-data"> 
								<input type="hidden" name="gett" value="<?php echo $editid?>">
								<div class="form-group"> 
									<label for="exampleInputEmail1">Services Name</label> 
									<input type="text" class="form-control" id="" name="product_name" value="<?php echo $product['sevices_name'];?>" > 
								...
								<div class="form-group"> 
									...
									<input type="text" class="form-control"  name="icon" required="" value="<?php echo $product['icon']; ?>" > 
								...
								<div class="form-group"> 
								 <label>Status</label>
                        				<select class="form-control" name="stockstatus" required="">
                                            <option 
                                             <?php if($product['service_status']==1){ echo 'selecte';}?> value="1">Active
                                            </option>
                           					<option <?php if($product['service_status']==2){ echo 'selecte';}?> value="2">Inactive
                           					</option>
                        				</select>
                        		</div>
                        				<?php if(isset($error))
								...
								<input type="hidden" name="oldpic" value="<?php echo $product['service_pic']?>">
								<?php if(isset($error))
										{?>
												<div class="custom"> <?php echo strip_tags(form_error($imgerror['error']));?></div>
  				...
  				<?php  };?>
				    ...
				    <div class="form-group col-12">
						...
						<div class="dz-image" style="margin-top: 5px;">
							<?php $img=explode(",",$product['service_pic']);
