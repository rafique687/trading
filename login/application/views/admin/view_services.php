...
<!-- main content start-->
    <div id="page-wrapper">
      <div class="main-page">
        <div class="tables">
          <a href="<?php echo site_url()?>/Services/addservice" class="btn btn-info pull-right">Add Service</a>
        ...
        <div class="table-responsive bs-example widget-shadow">
            ...
            <?php if(isset($_GET['success']))
              ...
              <tbody> 
                ...
                <tr> 
                  <td><?php echo $i ?></td>
                            <td><?php echo $prod['sevices_name'];?></td>
                            <td><?php echo $prod['service_des']?></td>
                            <td>
                              <?php $dd=list($street) = explode(',',$prod['service_pic'] )[0];?>
                            ...
                            <td>
                              <a href="<?php echo site_url()?>Services/edititem?id=<?php echo $prod['service_id']?>" class="btn btn-info"><i class="fa fa-edit"></i>
                              </a>
                                <a href="<?php echo site_url()?>Services/deleteitem?id=<?php echo $prod['service_id']?>" class="btn btn-danger"><i class="fa fa-trash"></i>
                                </a>
                                <?php if($prod['service_status']==1)
                          {  ?>
                        
                          <!-- <input type="hidden" id="status" value="<?php echo $prod['status'];?>" class="status"> -->
                            <label class="switch"><input type="checkbox" value="<?php echo $prod['service_id'],",".$prod['service_status']?>" checked class="checkss" name="status">
