    ...
    <div id="page-wrapper">
      <div class="main-page">
        <div class="tables" style="margin-top:20px;">
          ...
          <h2 class="title1">WhatsApp Message</h2>
        
          <div class="table-responsive bs-example widget-shadow">
            <!-- <table id="example" class="table table-striped table-bordered" style="width:100%"> -->
          
            <h4>WhatsApp Receiver</h4>
            ...
            <?php if(isset($_GET['sucess']))
              ...
              <tbody> 
                ...
                // echo "<pre>"; print_r($recored);exit;
                 $Receiver=explode("," ,$recored['customerno']);
                 foreach($Receiver as $prod)
                  {?>
                    <tr> 
                      <td style="width:20px;"><?php echo $i ?></th> 
                      <td><?php echo $recored['message'];?></td>
                      <td><?php echo $recored['date'];?></td>
                      <td><?php echo $prod?></td>
                   </tr> 
              <?php
                  $i++;
