        ...
        <div class="table-responsive bs-example widget-shadow">
           ...
           <h4>Sent Mail List</h4>
            ...
            <?php if(isset($_GET['success']))
              ...
              <tbody> 
                 <?php  $i=1;
                foreach($mailsent as $prod){?>
                 
                <tr> 
                  <td><?php echo $i ?></td>
                            <td><?php echo $prod['subject'];?></td>
                            <td><?php echo $prod['message']?></td>
                            <td><?php echo $prod['attachment']?></td>
                             <td><?php echo $prod['date']?></td>
                             <td><a href="<?php echo site_url()?>customer/allthismailreceicer?id=<?php echo $prod['mail_id']?>">All user</a></td>
