				...
				<div class="forms">
			 	 ...
			 	 <?php  };?>
					...
					<div class="form-group"> 
						...
						<input type="text" class="form-control" id="degi" name="work" placeholder="Enter Designation" required=""  value="<?php echo set_value('work'); ?>"> 
			 	 ...
			 	 <?php  };?>
					...
					<div class="form-group"> 
						...
						<input type="text" class="form-control" id="degi" name="fb" placeholder="Enter Facebook" required=""  value="<?php echo set_value('fb'); ?>"> 
			 	 ...
			 	 <?php  };?>
					...
					<div class="form-group"> 
						...
						<input type="text" class="form-control" id="degi" name="tw" placeholder="Enter Twitter Url" required=""  value="<?php echo set_value('tw'); ?>"> 
			 	 ...
			 	 <?php  };?>
					...
					<div class="form-group"> 
						...
						<input type="text" class="form-control" id="degi" name="ig" placeholder="Enter Instagram Url" required=""  value="<?php echo set_value('ig'); ?>"> 
			 	 ...
			 	 <?php  };?>
					...
					<div class="form-group"> 
						...
						<input type="text" class="form-control" id="degi" name="in" placeholder="Enter Linked In Url" required=""  value="<?php echo set_value('in'); ?>"> 
