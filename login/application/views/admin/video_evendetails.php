		...
		<div class="forms">
			...
			<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
				...
				<div class="form-body">
						...
						<form  action="<?php echo site_url()?>/Event/inserteventdetails" method="post" enctype="multipart/form-data">
					...
					<?php } ?>
						...
						<div class="form-group" id="photo" style="display:none;"> 
							...
							<input type="text" class="form-control" name="phototitle" placeholder="Enter Photo Title"> 
						...
						<div class="form-group" id="eventurl" style="display: none;"> 
							<label for="exampleInputEmail1">Url Title</label> 
							<input type="text" class="form-control" name="urltitle" placeholder="Enter Photo Title">
